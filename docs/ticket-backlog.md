...
| TICKET-013 | In implementation on `codex/ticket-013-task-first-quest-log` | The task-first hierarchy, compact deadline disclosure, Realm Map pointer, persisted Guild progress drawer, and responsive browser contracts are implemented locally; hosted preview review remains. |
