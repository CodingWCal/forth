...
Claude Code and Codex share the same project instructions and backlog.

Before changing code:

1. Read [`AGENTS.md`](AGENTS.md) completely.
2. Read [`CONTRIBUTING.md`](CONTRIBUTING.md) before proposing or implementing cohort contribution work.
3. Read [`docs/AGENT_HANDOFF.md`](docs/AGENT_HANDOFF.md) for the latest branch, checks, risks, and next step.
